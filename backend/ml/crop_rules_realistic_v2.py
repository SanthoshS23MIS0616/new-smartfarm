...
CROP_DATABASE: dict[str, dict[str, object]] = {
    ...
    "chickpea": {
        ...
        "water_need": "low",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (48.0, 70.0),
        "base_price_rs_per_kg": 56.0,
        "base_cost_rs_per_ha": 36000.0,
    ...
    "kidneybeans": {
        ...
        "water_need": "medium",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (60.0, 85.0),
        "base_price_rs_per_kg": 70.0,
        "base_cost_rs_per_ha": 42000.0,
        "sowing_months": [6, 7],
        "peak_harvest_months": [9, 10],
        "new_farmer_penalty": 0.22,
        "base_risk": 0.32,
        "base_sustainability": 0.76,
        "price_volatility": 0.20,
        "chemical_dependency": 0.15,
        "soil_sensitivity": 0.18,
        "mono_crop_penalty": 0.08,
    },
    "pigeonpeas": {
        ...
        "water_need": "low",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (55.0, 75.0),
        "base_price_rs_per_kg": 62.0,
        "base_cost_rs_per_ha": 34000.0,
        "sowing_months": [6, 7, 9],  # Sep: late kharif pigeonpeas is widely practiced
        "peak_harvest_months": [11, 12, 1],
        "new_farmer_penalty": 0.20,
        "base_risk": 0.28,
        "base_sustainability": 0.84,
        "price_volatility": 0.18,
        "chemical_dependency": 0.10,
        "soil_sensitivity": 0.14,
    ...
    "mothbeans": {
        ...
        "water_need": "low",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (50.0, 68.0),
        "base_price_rs_per_kg": 58.0,
        "base_cost_rs_per_ha": 28000.0,
        "sowing_months": [6, 7, 8, 9],  # Sep: 3-month crop fits late kharif perfectly
        "peak_harvest_months": [9, 10],
        "new_farmer_penalty": 0.18,
        "base_risk": 0.25,
        "base_sustainability": 0.86,
        "price_volatility": 0.15,
        "chemical_dependency": 0.10,
        "soil_sensitivity": 0.12,
        "mono_crop_penalty": 0.06,
    },
    "mungbean": {
        "crop_type": "annual",
        ...
        "sowing_months": [3, 4, 6, 7],
        "peak_harvest_months": [6, 7, 9, 10],
        "new_farmer_penalty": 0.18,
        "base_risk": 0.26,
        "base_sustainability": 0.85,
        "price_volatility": 0.16,
        "chemical_dependency": 0.10,
        "soil_sensitivity": 0.12,
        "mono_crop_penalty": 0.06,
    ...
    "cotton": {
        ...
        "water_need": "medium",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (55.0, 80.0),
    ...
    "watermelon": {
        ...
        "base_cost_rs_per_ha": 55000.0,
        "sowing_months": [2, 3, 4],
        "peak_harvest_months": [5, 6, 7],
        "new_farmer_penalty": 0.26,
        "base_risk": 0.40,
    ...
    "muskmelon": {
        ...
        "water_need": "medium",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (10.0, 22.0),
        "base_price_rs_per_kg": 15.0,
        "base_cost_rs_per_ha": 48000.0,
        "sowing_months": [2, 3, 4],
        "peak_harvest_months": [5, 6, 7],
        "new_farmer_penalty": 0.24,
        "base_risk": 0.36,
    ...
    "wheat": {
        ...
        "water_need": "medium",
        "irrigation_requirement": "needs_irrigation",
        "price_range_rs_per_kg": (20.0, 28.0),
        "base_price_rs_per_kg": 23.0,
        "base_cost_rs_per_ha": 55000.0,
        "sowing_months": [10, 11, 12],
        "peak_harvest_months": [3, 4],
        "new_farmer_penalty": 0.18,
        "base_risk": 0.28,
        "base_sustainability": 0.62,
        "price_volatility": 0.12,
        "chemical_dependency": 0.20,
        "soil_sensitivity": 0.16,
        "mono_crop_penalty": 0.14,
    },
    "soybean": {
        "crop_type": "annual",
        ...
        "water_need": "medium",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (38.0, 55.0),
        "base_price_rs_per_kg": 44.0,
        "base_cost_rs_per_ha": 42000.0,
        "sowing_months": [6, 7],
        "peak_harvest_months": [10, 11],
        "new_farmer_penalty": 0.20,
        "base_risk": 0.30,
        "base_sustainability": 0.72,
        "price_volatility": 0.20,
    ...
    "groundnut": {
        ...
        "base_price_rs_per_kg": 62.0,
        "base_cost_rs_per_ha": 38000.0,
        "sowing_months": [6, 7, 2, 3],
        "peak_harvest_months": [10, 11, 6, 7],
        "new_farmer_penalty": 0.20,
        "base_risk": 0.30,
    ...
    "sugarcane": {
        ...
        "water_need": "high",
        "irrigation_requirement": "needs_irrigation",
        "price_range_rs_per_kg": (3.0, 4.5),
        "base_price_rs_per_kg": 3.5,
        "base_cost_rs_per_ha": 85000.0,
        "sowing_months": [10, 11, 2, 3],
        "peak_harvest_months": [10, 11, 12],
        "new_farmer_penalty": 0.28,
        "base_risk": 0.38,
        "base_sustainability": 0.46,
        "price_volatility": 0.14,
        "chemical_dependency": 0.28,
        "soil_sensitivity": 0.22,
        "mono_crop_penalty": 0.16,
    },
    "sunflower": {
        "crop_type": "annual",
        "duration_months": 4,
        ...
        "water_need": "low",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (45.0, 65.0),
        "base_price_rs_per_kg": 54.0,
        "base_cost_rs_per_ha": 32000.0,
        "sowing_months": [10, 11, 2, 3],
        "peak_harvest_months": [2, 3, 5, 6],
        "new_farmer_penalty": 0.20,
        "base_risk": 0.28,
        "base_sustainability": 0.76,
        "price_volatility": 0.20,
    ...
    "sorghum": {
        ...
        "base_price_rs_per_kg": 22.0,
        "base_cost_rs_per_ha": 28000.0,
        "sowing_months": [6, 7, 9, 10, 11],  # Sep added: late kharif / early rabi transition
        "peak_harvest_months": [10, 11, 2, 3],
        "new_farmer_penalty": 0.16,
        "base_risk": 0.24,
        "base_sustainability": 0.84,
        "price_volatility": 0.14,
        "chemical_dependency": 0.10,
    ...
    "onion": {
        ...
        "water_need": "medium",
        "irrigation_requirement": "needs_irrigation",
        "price_range_rs_per_kg": (10.0, 40.0),
        "base_price_rs_per_kg": 18.0,
        "base_cost_rs_per_ha": 52000.0,
        "sowing_months": [9, 10, 11, 5, 6],  # Sep added: nursery raising starts Sep in many regions
        "peak_harvest_months": [2, 3, 9, 10],
        "new_farmer_penalty": 0.28,
        "base_risk": 0.50,
        "base_sustainability": 0.50,
    ...
    "tomato": {
        ...
        "water_need": "high",
        "irrigation_requirement": "needs_irrigation",
        "price_range_rs_per_kg": (8.0, 35.0),
        "base_price_rs_per_kg": 15.0,
        "base_cost_rs_per_ha": 62000.0,
        "sowing_months": [6, 7, 9, 10, 11],  # Sep added: autumn crop sowing is standard practice
        "peak_harvest_months": [9, 10, 1, 2],
        "new_farmer_penalty": 0.30,
        "base_risk": 0.52,
        "base_sustainability": 0.48,
        "price_volatility": 0.46,
    ...
    "chilli": {
        ...
        "water_need": "medium",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (80.0, 160.0),
        "base_price_rs_per_kg": 110.0,
        "base_cost_rs_per_ha": 58000.0,
        "sowing_months": [6, 7, 9, 10, 11],  # Sep added: autumn/rabi chilli widely sown in Sep
        "peak_harvest_months": [11, 12, 3, 4],
        "new_farmer_penalty": 0.28,
        "base_risk": 0.46,
    ...
    "pomegranate": {
        ...
        "water_need": "low",
        "irrigation_requirement": "rain_fed_ok",
        "price_range_rs_per_kg": (60.0, 100.0),
        "base_price_rs_per_kg": 78.0,
        "base_cost_rs_per_ha": 180000.0,
        "sowing_months": [6, 7, 8],
